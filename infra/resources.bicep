...
resource ollamaAspireAIBlazorChatBotAppHostOllamaOllamaFileShare 'Microsoft.Storage/storageAccounts/fileServices/shares@2022-05-01' = {
  parent: storageVolumeFileService
  name: take('${toLower('ollama')}-${toLower('AspireAIBlazorChatBotAppHostollamaollama')}', 60)
  properties: {
    shareQuota: 1024
...
resource ollamaAspireAIBlazorChatBotAppHostOllamaOllamaStore 'Microsoft.App/managedEnvironments/storages@2023-05-01' = {
  parent: containerAppEnvironment
  name: take('${toLower('ollama')}-${toLower('AspireAIBlazorChatBotAppHostollamaollama')}', 32)
  properties: {
    azureFile: {
      shareName: ollamaAspireAIBlazorChatBotAppHostOllamaOllamaFileShare.name
